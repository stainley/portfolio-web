...
#docker  build --build-arg "$PORTFOLIO_VERSION" -t "kubernetes-master:5000/$APP_NAME-dev:$PORTFOLIO_VERSION" -t "kubernetes-master:5000/$APP_NAME-dev:latest" -f Dockerfile.dev .
...
#echo "Uploading image $REACT_APP_NAME-dev to Local Docker Registry"
#docker push "kubernetes-master:5000/$REACT_APP_NAME-dev"
